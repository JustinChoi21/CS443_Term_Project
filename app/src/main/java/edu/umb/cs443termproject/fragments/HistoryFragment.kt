        ...
        button.setOnClickListener {
            lifecycleScope.launch {
                ...
                val historyList = arrayListOf(
                    ...
                    History(EventType.Tire.value, "12/01/2022", "At Service center & price $100", 0, 0),
                    History(EventType.RegularService.value, "12/01/2022", "At Service center & price $120", 0, 0),
                    History(EventType.Refuel.value, "11/13/2022", "Fuel Amount: 25Gal & Price: $75", 25, 75),
                    History(EventType.Refuel.value, "10/15/2022", "Fuel Amount: 20Gal & Price: $60", 20, 60),
                    History(EventType.Refuel.value, "09/20/2022", "Fuel Amount: 15Gal & Price: $45", 15, 45),
                    History(EventType.Refuel.value, "08/21/2022", "Fuel Amount: 20Gal & Price: $60", 20, 60),
                    History(EventType.EngineOil.value, "08/12/2022", "At service center & price $50", 0, 0),
                    History(EventType.Tire.value, "08/12/2022", "At Service center & price $100", 0, 0),
                    History(EventType.RegularService.value, "08/12/2022", "At Service center & price $120", 0, 0),
                    History(EventType.Refuel.value, "07/10/2022", "Fuel Amount: 25Gal & Price: $75", 25, 75),
                    History(EventType.Refuel.value, "06/11/2022", "Fuel Amount: 23Gal & Price: $69", 23, 69),
                    History(EventType.Refuel.value, "05/15/2022", "Fuel Amount: 18Gal & Price: $54", 18, 54),
                    History(EventType.Refuel.value, "04/15/2022", "Fuel Amount: 14Gal & Price: $42", 14, 42),
                    History(EventType.EngineOil.value, "04/12/2022", "At service center & price $50", 0, 0),
                    History(EventType.Tire.value, "04/12/2022", "At Service center & price $100", 0, 0),
                    History(EventType.RegularService.value, "04/12/2022", "At Service center & price $120", 0, 0),
                    History(EventType.Refuel.value, "03/15/2022", "Fuel Amount: 21Gal & Price: $63", 21, 63),
                    History(EventType.Refuel.value, "02/11/2022", "Fuel Amount: 19Gal & Price: $57", 19, 57),
                    History(EventType.Refuel.value, "01/23/2022", "Fuel Amount: 12Gal & Price: $36", 12, 36),
                )
