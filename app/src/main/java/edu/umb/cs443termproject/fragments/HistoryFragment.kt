        ...
        button.setOnClickListener {
            lifecycleScope.launch {
                ...
                val historyList = arrayListOf(
                    ...
                    History(EventType.EngineOil.value, "12/01/22", "At service center & price $50", 0, 0),
                    ...
                    History(EventType.Tire.value, "08/12/22", "At Service center & price $100", 0, 0),
                    History(EventType.RegularService.value, "08/12/22", "At Service center & price $120", 0, 0),
                    ...
                    History(EventType.EngineOil.value, "04/12/22", "At service center & price $50", 0, 0),
                    History(EventType.Tire.value, "04/12/22", "At Service center & price $100", 0, 0),
                    History(EventType.RegularService.value, "04/12/22", "At Service center & price $120", 0, 0),
